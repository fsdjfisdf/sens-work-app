document.addEventListener('DOMContentLoaded', () => {
    ...
    const supranMaintenanceTable = document.getElementById('supran-maintenance-table');
    ...
    function hideAllTables() {
      ...
      supranMaintenanceTable.style.display = 'none';
    ...
    selfCheckButton.addEventListener('click', () => {
      hideAllTables();
      supranMaintenanceTable.style.display = 'table';
      removeActiveClass();
