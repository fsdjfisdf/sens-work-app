...
async function loadDbTaskCounts() {
    try {
        const response = await axios.get('http://3.37.73.151:3001/api/hdw-task-count');
...
try {
    const response = await axios.post('http://3.37.73.151:3001/api/hdw-maintenance/aggregated', aggregatedData, {
