document.addEventListener("DOMContentLoaded", function() {
    ...
    const hdwMaintenanceTable = document.getElementById("hdw-maintenance-table");

    // 모든 테이블을 숨기기
    function hideAllTables() {
        combinedTable.classList.remove("active");
        taskCountTable.classList.remove("active");
        hdwMaintenanceTable.classList.remove("active");
    }
    ...
    selfButton.addEventListener("click", function() {
        hideAllTables();
        hdwMaintenanceTable.classList.add("active"); // SELF 테이블 표시
        resetButtonStyles();
