...
window.taskCategories = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { name: "M124V Teaching", 기준작업수: 5 },
      { name: "M124C Teaching", 기준작업수: 5 },
      { name: "Robot REP", 기준작업수: 5 },
      { name: "Robot Controller REP", 기준작업수: 5 }
    ]
  },
  {
    category: "TM Robot",
  ...
  },
  {
    category: "BM Module",
    subcategories: [
      { name: "Pin Cylinder", 기준작업수: 5 },
      { name: "Pusher Cylinder", 기준작업수: 5 },
      { name: "DRT", 기준작업수: 5 }
    ]
  },
  {
  ...
  },
  {
    category: "Microwave",
    subcategories: [
      { name: "Microwave", 기준작업수: 1 },
      { name: "Applicator", 기준작업수: 3 },
      { name: "Applicator Tube", 기준작업수: 3 },
      { name: "Generator", 기준작업수: 3 }
    ]
  },
  {
    category: "RF bias",
    subcategories: [
      { name: "Matcher", 기준작업수: 3 },
      { name: "Generator", 기준작업수: 3 }
    ]
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      { name: "Toplid Process Kit", 기준작업수: 1 },
      { name: "Chamber Process Kit", 기준작업수: 5 }
    ]
  },
  {
    category: "Leak",
    subcategories: [
      { name: "Helium Detector", 기준작업수: 5 }
    ]
  },
  {
    category: "Pin",
    subcategories: [
      ...
      { name: "Bellows", 기준작업수: 3 },
      { name: "Pin Sensor", 기준작업수: 3 },
      { name: "LM Guide", 기준작업수: 3 },
      { name: "HOOK LIFTER SERVO MOTOR", 기준작업수: 3 },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { name: "PMC", 기준작업수: 3 },
      { name: "EDA", 기준작업수: 3 },
      { name: "EFEM CONTROLLER", 기준작업수: 3 }
    ]
  },
  {
    category: "S/W",
    subcategories: [
      { name: "S/W Patch", 기준작업수: 1 }
    ]
  }
];
...
async function loadDbTaskCounts() {
    try {
        const response = await axios.get('http://3.37.73.151:3001/api/ecolite-task-count');
...
try {
    const response = await axios.post('http://3.37.73.151:3001/api/ecolite-maintenance/aggregated', aggregatedData, {
