document.addEventListener("DOMContentLoaded", function() {
    ...
    const ecoliteMaintenanceTable = document.getElementById("ecolite-maintenance-table");

    // 모든 테이블을 숨기기
    function hideAllTables() {
        combinedTable.classList.remove("active");
        taskCountTable.classList.remove("active");
        ecoliteMaintenanceTable.classList.remove("active");
    }
    ...
    selfButton.addEventListener("click", function() {
        hideAllTables();
        ecoliteMaintenanceTable.classList.add("active"); // SELF 테이블 표시
        resetButtonStyles();
