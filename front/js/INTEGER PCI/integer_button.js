document.addEventListener("DOMContentLoaded", function() {
    ...
    const integerMaintenanceTable = document.getElementById("integer-maintenance-table");

    // 모든 테이블을 숨기기
    function hideAllTables() {
        combinedTable.classList.remove("active");
        taskCountTable.classList.remove("active");
        integerMaintenanceTable.classList.remove("active");
    }
    ...
    selfButton.addEventListener("click", function() {
        hideAllTables();
        integerMaintenanceTable.classList.add("active"); // SELF 테이블 표시
        resetButtonStyles();
