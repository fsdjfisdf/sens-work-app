...
const taskCategories = [
    {
        ...
        subcategories: [
            ...
            { name: "AM BAFFLE", 기준작업수: 1 },
            { name: "FLANGE ADAPTOR", 기준작업수: 1 }
        ]
    },
    {
        category: "Slot Valve",
        subcategories: [
            { name: "SLOT VALVE ASSY(HOUSING)", 기준작업수: 1 },
            { name: "SLOT VALVE", 기준작업수: 1 },
            { name: "DOOR VALVE", 기준작업수: 1 }
        ]
    },
    {
    ...
    },
    {
        ...
        subcategories: [
            { name: "PIN ASSY MODIFY", 기준작업수: 2 },
            { name: "MOTOR & CONTROLLER", 기준작업수: 2 },
            { name: "PIN 구동부 ASSY", 기준작업수: 2 },
            { name: "PIN BELLOWS", 기준작업수: 2 },
            { name: "SENSOR", 기준작업수: 2 }
        ]
    },
    {
        ...
        subcategories: [
            { name: "STEP MOTOR & CONTROLLER", 기준작업수: 3 },
            { name: "CASSETTE & HOLDER PAD", 기준작업수: 1 },
            { name: "BALL SCREW ASSY", 기준작업수: 3 },
            { name: "BUSH", 기준작업수: 3 },
            { name: "MAIN SHAFT", 기준작업수: 3 },
    ...
    },
    {
        category: "Vac. Line",
        subcategories: [
            { name: "UNDER COVER", 기준작업수: 2 },
            { name: "VAC. LINE", 기준작업수: 2 },
            { name: "BARATRON GAUGE", 기준작업수: 2 },
            { name: "PIRANI GAUGE", 기준작업수: 2 },
            { name: "CONVACTRON GAUGE", 기준작업수: 2 },
            { name: "MANUAL VALVE", 기준작업수: 2 },
            { name: "PNEUMATIC VALVE", 기준작업수: 2 },
    ...
    },
    {
        category: "Chuck",
        subcategories: [
            { name: "COOLING CHUCK", 기준작업수: 2 },
            { name: "HEATER CHUCK", 기준작업수: 2 }
        ]
    },
    {
        category: "Rack",
    ...
    },
    {
        category: "Sensor",
        subcategories: [
            { name: "CODED SENSOR", 기준작업수: 2 },
            { name: "GAS BOX DOOR SENSOR", 기준작업수: 2 },
            { name: "LASER SENSOR AMP", 기준작업수: 2 }
        ]
    },
    {
        category: "ETC",
