document.addEventListener("DOMContentLoaded", function() {
    ...
    const preciaMaintenanceTable = document.getElementById("precia-maintenance-table");

    // 모든 테이블을 숨기기
    function hideAllTables() {
        combinedTable.classList.remove("active");
        taskCountTable.classList.remove("active");
        preciaMaintenanceTable.classList.remove("active");
    }
    ...
    selfButton.addEventListener("click", function() {
        hideAllTables();
        preciaMaintenanceTable.classList.add("active"); // SELF 테이블 표시
        resetButtonStyles();
