document.addEventListener('DOMContentLoaded', function() {
    ...
    const transferOptions = { // SR8241 TEACHING, SR8240 TEACHING, M124 TEACHING, SR8250 TEACHING, SR8232 TEACHING, PRISM, IO BOX, FPS BOARD, HEATING JACKET, WATER LEAK DETECTOR, MANOMETER, TEMP LIMIT CONTROLLER, TEMP CONTROLLER
        "SUPRA N": ["SELECT", "LP ESCORT", "ROBOT ESCORT", "SR8241 TEACHING", "SR8240 TEACHING", "M124 TEACHING", "EFEM ROBOT REP", "EFEM ROBOT CONTROLLER",
        "SR8250 TEACHING", "SR8232 ROBOT TEACHING", "TM ROBOT REP", "TM ROBOT CONTROLLER", "PASSIVE PAD REP", "PIN CYLINDER", "PUSHER CYLINDER", "IB FLOW", "DRT", "FFU CONTROLLER", "FAN", "MOTOR DRIVER",
        "R1","R3","R5","PRISM", "R3 TO R5", "MICROWAVE", "APPLICATOR", "GENERATOR", "CHUCK", "PROCESS KIT", "HELIUM DETECTOR", "HOOK LIFT PIN", "BELLOWS",
