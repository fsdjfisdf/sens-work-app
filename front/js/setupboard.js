(() => {
  ...
  const STEPS = [
    ...
    { no: 9,  name: 'CHILLER T/O', desc: 'CHUCK TEMP 조절 CHILLER TURN ON' },
    { no: 10, name: 'HEAT EX T/O', desc: 'WALL TEMP 조절 HEAT EXCHANGER TURN ON' },
    { no: 11, name: 'PUMP T/O', desc: 'TM/PM/AM/LL PUMP TURN ON 후 방치압 TEST 및 LEAK 검증' },
    { no: 12, name: 'TEACHING', desc: 'EFEM/TM ROBOT 및 모듈 TEACHING' },
