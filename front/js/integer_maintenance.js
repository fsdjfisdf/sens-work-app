document.addEventListener('DOMContentLoaded', async () => {
    ...
    form.addEventListener('submit', async (event) => {
        ...
        const checklistFields = [
            ...
            'PNEUMATIC_VALVE', 'ISOLATION_VALVE', 'VACUUM_BLOCK', 'CHECK_VALVE', 'EPC', 'COOLING_CHUCK', 'HEATER_CHUCK',
            'GENERATOR', 'AIO_CALIBRATION[PSK_BOARD]', 'AIO_CALIBRATION[TOS_BOARD]', 'CODED_SENSOR', 'GAS_BOX_DOOR_SENSOR',
