document.addEventListener("DOMContentLoaded", function() {
    ...
    const supraMaintenanceTable = document.getElementById("supra-maintenance-table");

    // 모든 테이블을 숨기기
    function hideAllTables() {
        combinedTable.classList.remove("active");
        taskCountTable.classList.remove("active");
        supraMaintenanceTable.classList.remove("active");
    }
    ...
    selfButton.addEventListener("click", function() {
        hideAllTables();
        supraMaintenanceTable.classList.add("active"); // SELF 테이블 표시
        resetButtonStyles();
