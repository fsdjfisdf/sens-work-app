...
app.post('/sign-up', async (req, res) => {
  ...
  app.post('/log', async (req, res) => {
    ...
    const { task_name, task_worker, task_result, task_cause, task_description, task_date, start_time, end_time, none_time, move_time, group, site, line, equipment_type, equipment_name, workType, setupItem, status } = req.body;
  
    const taskWorker = task_worker || '';
    ...
    logger.info('수정된 요청 데이터:', { task_name, taskWorker, taskResult, taskCause, taskDescription, taskDate, startTime, endTime, noneTime, moveTime, taskGroup, taskSite, taskLine, taskEquipmentType, taskEquipmentName, taskWorkType, taskSetupItem, taskStatus });
  
    try {
      const query = `
        INSERT INTO work_log 
        (task_name, task_worker, task_result, task_cause, task_description, task_date, start_time, end_time, none_time, move_time, \`group\`, site, \`line\`, equipment_type, equipment_name, work_type, setup_item, status) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `;
      const values = [task_name, taskWorker, taskResult, taskCause, taskDescription, taskDate, startTime, endTime, noneTime, moveTime, taskGroup, taskSite, taskLine, taskEquipmentType, taskEquipmentName, taskWorkType, taskSetupItem, taskStatus];
