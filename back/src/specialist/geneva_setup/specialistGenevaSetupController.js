const dao = require("./specialistGenevaSetupDao");
...
exports.getWorkers = async (_req, res) => {
  try{
    ...
    console.error("[GenevaSetup] getWorkers error:", e);
...
exports.getEducationByWorker = async (req, res) => {
  try{
    ...
    console.error("[GenevaSetup] getEducationByWorker error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
...
exports.patchCell = async (req, res) => {
  try{
    ...
    console.error("[GenevaSetup] patchCell error:", e);
...
exports.ensureWorkerRow = async (req, res)=>{
  try{
    ...
    console.error("[GenevaSetup] ensureWorkerRow error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
