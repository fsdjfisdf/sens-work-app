const dao = require("./specialistSupranSetupDao");
...
exports.getWorkers = async (_req, res) => {
  try{
    ...
    console.error("[SupranSetup] getWorkers error:", e);
...
exports.getEducationByWorker = async (req, res) => {
  try{
    ...
    console.error("[SupranSetup] getEducationByWorker error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
...
exports.patchCell = async (req, res) => {
  try{
    ...
    console.error("[SupranSetup] patchCell error:", e);
...
exports.ensureWorkerRow = async (req, res)=>{
  try{
    ...
    console.error("[SupranSetup] ensureWorkerRow error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
