const dao = require("./specialistEcoliteSetupDao");
...
exports.getWorkers = async (_req, res) => {
  try{
    ...
    console.error("[EcoliteSetup] getWorkers error:", e);
...
exports.getEducationByWorker = async (req, res) => {
  try{
    ...
    console.error("[EcoliteSetup] getEducationByWorker error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
...
exports.patchCell = async (req, res) => {
  try{
    ...
    console.error("[EcoliteSetup] patchCell error:", e);
...
exports.ensureWorkerRow = async (req, res)=>{
  try{
    ...
    console.error("[EcoliteSetup] ensureWorkerRow error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
