const dao = require("./specialistIntegerSetupDao");
...
exports.getWorkers = async (_req, res) => {
  try{
    ...
    console.error("[IntegerSetup] getWorkers error:", e);
...
exports.getEducationByWorker = async (req, res) => {
  try{
    ...
    console.error("[IntegerSetup] getEducationByWorker error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
...
exports.patchCell = async (req, res) => {
  try{
    ...
    console.error("[IntegerSetup] patchCell error:", e);
...
exports.ensureWorkerRow = async (req, res)=>{
  try{
    ...
    console.error("[IntegerSetup] ensureWorkerRow error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
