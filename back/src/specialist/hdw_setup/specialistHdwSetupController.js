const dao = require("./specialistHdwSetupDao");
...
exports.getWorkers = async (_req, res) => {
  try{
    ...
    console.error("[HdwSetup] getWorkers error:", e);
...
exports.getEducationByWorker = async (req, res) => {
  try{
    ...
    console.error("[HdwSetup] getEducationByWorker error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
...
exports.patchCell = async (req, res) => {
  try{
    ...
    console.error("[HdwSetup] patchCell error:", e);
...
exports.ensureWorkerRow = async (req, res)=>{
  try{
    ...
    console.error("[HdwSetup] ensureWorkerRow error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
