const dao = require("./specialistSupraxpSetupDao");
...
exports.getWorkers = async (_req, res) => {
  try{
    ...
    console.error("[SupraxpSetup] getWorkers error:", e);
...
exports.getEducationByWorker = async (req, res) => {
  try{
    ...
    console.error("[SupraxpSetup] getEducationByWorker error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
...
exports.patchCell = async (req, res) => {
  try{
    ...
    console.error("[SupraxpSetup] patchCell error:", e);
...
exports.ensureWorkerRow = async (req, res)=>{
  try{
    ...
    console.error("[SupraxpSetup] ensureWorkerRow error:", e);
    res.status(500).json({ message:"internal_error" });
  }
};
