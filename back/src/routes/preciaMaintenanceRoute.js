const preciamaintenanceController = require("../controllers/preciaMaintenanceController");
const jwtMiddleware = require("../../config/jwtMiddleware");

module.exports = function (app) {
  // 체크리스트 불러오기
  app.get("/precia-maintenance", jwtMiddleware, preciamaintenanceController.getChecklist);
