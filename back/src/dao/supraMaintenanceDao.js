  ...
  try {
    const query = `
      INSERT INTO SUPRA_N_MAINT_APPROVAL (
        name, checklist_data, approval_status, LP_ESCORT, ROBOT_ESCORT, SR8241_TEACHING, SR8240_TEACHING, M124_TEACHING, EFEM_FIXTURE, EFEM_ROBOT_REP, 
...
exports.saveChecklist = async (checklistData) => {
  ...
  try {
    ...
    const values = [
      ...
      JSON.stringify(checklistData), // JSON 필드만 포함
      ...
      checklistData.SR8232_TEACHING, checklistData.TM_FIXTURE, checklistData.TM_ROBOT_REP,
      checklistData.TM_ROBOT_CONTROLLER_REP, checklistData.PASSIVE_PAD_REP, checklistData.PIN_CYLINDER,
      checklistData.PUSHER_CYLINDER, checklistData.IB_FLOW, checklistData.DRT,
      checklistData.FFU_CONTROLLER, checklistData.FAN, checklistData.MOTOR_DRIVER,
      checklistData.R1, checklistData.R3, checklistData.R5, checklistData.R3_TO_R5,
      checklistData.PRISM, checklistData.MICROWAVE, checklistData.APPLICATOR,
      checklistData.GENERATOR, checklistData.CHUCK, checklistData.PROCESS_KIT,
      checklistData.HELIUM_DETECTOR, checklistData.HOOK_LIFT_PIN, checklistData.BELLOWS,
      checklistData.PIN_SENSOR, checklistData.LM_GUIDE, checklistData.PIN_MOTOR_CONTROLLER,
      checklistData.SINGLE_EPD, checklistData.DUAL_EPD, checklistData.GAS_BOX_BOARD,
      checklistData.TEMP_CONTROLLER_BOARD, checklistData.POWER_DISTRIBUTION_BOARD,
      checklistData.DC_POWER_SUPPLY, checklistData.BM_SENSOR, checklistData.PIO_SENSOR,
      checklistData.SAFETY_MODULE, checklistData.IO_BOX, checklistData.FPS_BOARD,
      checklistData.D_NET, checklistData.MFC, checklistData.VALVE, checklistData.SOLENOID,
      checklistData.FAST_VAC_VALVE, checklistData.SLOW_VAC_VALVE, checklistData.SLIT_DOOR,
      checklistData.APC_VALVE, checklistData.SHUTOFF_VALVE, checklistData.BARATRON_ASSY,
      checklistData.PIRANI_ASSY, checklistData.VIEW_PORT_QUARTZ, checklistData.FLOW_SWITCH,
      checklistData.CERAMIC_PLATE, checklistData.MONITOR, checklistData.KEYBOARD,
