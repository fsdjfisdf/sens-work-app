...
exports.insertChecklist = async (checklistData) => {
    ...
    try {
      ...
      const values = [
        ...
        checklistData['DUAL'], checklistData['DC_POWER_SUPPLY'], checklistData['PIO_SENSOR'], checklistData['D-NET'],
        checklistData['SIM_BOARD'], checklistData['MFC'], checklistData['VALVE'], checklistData['SOLENOID'],
        checklistData['PENDULUM_VALVE'], checklistData['SLOT_VALVE_/_DOOR_VALVE'], checklistData['SHUTOFF_VALVE'],
...
exports.updateChecklist = async (checklistData) => {
    ...
    try {
      ...
      const values = [
        ...
        checklistData['DC_POWER_SUPPLY'], checklistData['PIO_SENSOR'], checklistData['D-NET'], checklistData['SIM_BOARD'],
        checklistData['MFC'], checklistData['VALVE'], checklistData['SOLENOID'], checklistData['PENDULUM_VALVE'],
        checklistData['SLOT_VALVE_/_DOOR_VALVE'], checklistData['SHUTOFF_VALVE'], checklistData['RF_GENERATOR'],
