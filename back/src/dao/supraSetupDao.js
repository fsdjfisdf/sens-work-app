...
exports.saveChecklist = async (data) => {
  const query = `
      ...
      ON DUPLICATE KEY UPDATE
          ...
          updated_at = NOW(),
          DRAWING_TEMPLATE_SETUP = VALUES(DRAWING_TEMPLATE_SETUP),
          DRAWING_TEMPLATE_MARKING = VALUES(DRAWING_TEMPLATE_MARKING),
          CUSTOMER_OHT_LINE_CHECK = VALUES(CUSTOMER_OHT_LINE_CHECK),
          UTILITY_SPEC_UNDERSTANDING = VALUES(UTILITY_SPEC_UNDERSTANDING),
          EQUIPMENT_IMPORT_CAUTION = VALUES(EQUIPMENT_IMPORT_CAUTION),
          EQUIPMENT_IMPORT_ORDER = VALUES(EQUIPMENT_IMPORT_ORDER),
          EQUIPMENT_SPACING_CHECK = VALUES(EQUIPMENT_SPACING_CHECK),
          PACKING_LIST_CHECK = VALUES(PACKING_LIST_CHECK),
          TOOL_SIZE_UNDERSTANDING = VALUES(TOOL_SIZE_UNDERSTANDING),
          LASER_JIG_ALIGNMENT = VALUES(LASER_JIG_ALIGNMENT),
          LIFT_CASTER_REMOVAL = VALUES(LIFT_CASTER_REMOVAL),
          MODULE_HEIGHT_DOCKING = VALUES(MODULE_HEIGHT_DOCKING),
          MODULE_DOCKING = VALUES(MODULE_DOCKING),
          DOCKING_REALIGNMENT = VALUES(DOCKING_REALIGNMENT),
          LEVELER_POSITION_UNDERSTANDING = VALUES(LEVELER_POSITION_UNDERSTANDING),
          MODULE_LEVELING = VALUES(MODULE_LEVELING),
          HOOK_UP = VALUES(HOOK_UP),
          TRAY_CHECK = VALUES(TRAY_CHECK),
          CABLE_SORTING = VALUES(CABLE_SORTING),
          GRATING_OPEN_CAUTION = VALUES(GRATING_OPEN_CAUTION),
          LADDER_SAFETY_RULES = VALUES(LADDER_SAFETY_RULES),
          CABLE_INSTALLATION = VALUES(CABLE_INSTALLATION),
          CABLE_CONNECTION = VALUES(CABLE_CONNECTION),
          CABLE_TRAY_ARRANGEMENT = VALUES(CABLE_TRAY_ARRANGEMENT),
          CABLE_CUTTING = VALUES(CABLE_CUTTING),
          PUMP_CABLE_TRAY = VALUES(PUMP_CABLE_TRAY),
          PUMP_CABLE_ARRANGEMENT = VALUES(PUMP_CABLE_ARRANGEMENT),
          CABLE_PM_PUMP_CONNECTION = VALUES(CABLE_PM_PUMP_CONNECTION),
          GPS_UPS_SPS_UNDERSTANDING = VALUES(GPS_UPS_SPS_UNDERSTANDING),
          POWER_TURN_ON_SEQUENCE = VALUES(POWER_TURN_ON_SEQUENCE),
          RACK_CB_UNDERSTANDING = VALUES(RACK_CB_UNDERSTANDING),
          SYCON_NUMBER_UNDERSTANDING = VALUES(SYCON_NUMBER_UNDERSTANDING),
          MODULE_CB_TURN_ON = VALUES(MODULE_CB_TURN_ON),
          SAFETY_MODULE_UNDERSTANDING = VALUES(SAFETY_MODULE_UNDERSTANDING),
          EMO_CHECK = VALUES(EMO_CHECK),
          POWER_TURN_ON_ALARM_TROUBLESHOOTING = VALUES(POWER_TURN_ON_ALARM_TROUBLESHOOTING),
          UTILITY_TURN_ON_SEQUENCE = VALUES(UTILITY_TURN_ON_SEQUENCE),
          VACUUM_TURN_ON = VALUES(VACUUM_TURN_ON),
          CDA_TURN_ON = VALUES(CDA_TURN_ON),
          PCW_TURN_ON = VALUES(PCW_TURN_ON),
          GAS_TURN_ON = VALUES(GAS_TURN_ON),
          GAS_TURN_ON_CHECK = VALUES(GAS_TURN_ON_CHECK),
          OX_NX_GAS_TURN_ON = VALUES(OX_NX_GAS_TURN_ON),
          MANOMETER_LIMIT_ADJUST = VALUES(MANOMETER_LIMIT_ADJUST),
          EFEM_ROBOT_PENDANT_CONTROL = VALUES(EFEM_ROBOT_PENDANT_CONTROL),
          EFEM_ROBOT_LEVELING = VALUES(EFEM_ROBOT_LEVELING),
          EFEM_ROBOT_ARM_LEVELING = VALUES(EFEM_ROBOT_ARM_LEVELING),
          EFEM_TEACHING_DATA_SAVE = VALUES(EFEM_TEACHING_DATA_SAVE),
          TM_ROBOT_PENDANT_CONTROL = VALUES(TM_ROBOT_PENDANT_CONTROL),
          TM_ROBOT_PICK_ADJUST = VALUES(TM_ROBOT_PICK_ADJUST),
          TM_ROBOT_BM_TEACHING = VALUES(TM_ROBOT_BM_TEACHING),
          TM_ROBOT_PM_TEACHING = VALUES(TM_ROBOT_PM_TEACHING),
          TM_TEACHING_DATA_SAVE = VALUES(TM_TEACHING_DATA_SAVE),
          WAFER_JIG_USE = VALUES(WAFER_JIG_USE),
          LASER_JIG_USE = VALUES(LASER_JIG_USE),
          FINE_TEACHING = VALUES(FINE_TEACHING),
          MARGIN_CHECK = VALUES(MARGIN_CHECK),
          SEMI_AUTO_TRANSFER = VALUES(SEMI_AUTO_TRANSFER),
          AGING_TEST = VALUES(AGING_TEST),
          BARATRON_PIRANI_GAUGE_INSTALLATION = VALUES(BARATRON_PIRANI_GAUGE_INSTALLATION),
          EPD_INSTALLATION = VALUES(EPD_INSTALLATION),
          PIO_SENSOR_CABLE_INSTALLATION = VALUES(PIO_SENSOR_CABLE_INSTALLATION),
          RACK_SIGNAL_TOWER_INSTALLATION = VALUES(RACK_SIGNAL_TOWER_INSTALLATION),
          CTC_INSTALLATION = VALUES(CTC_INSTALLATION),
          PORTABLE_RACK_INSTALLATION = VALUES(PORTABLE_RACK_INSTALLATION),
          PM_SAFETY_COVER_INSTALLATION = VALUES(PM_SAFETY_COVER_INSTALLATION),
          PROCESS_KIT_INSTALLATION = VALUES(PROCESS_KIT_INSTALLATION),
          PUMP_TURN_ON = VALUES(PUMP_TURN_ON),
          PM_LEAK_CHECK = VALUES(PM_LEAK_CHECK),
          GAS_LINE_LEAK_CHECK = VALUES(GAS_LINE_LEAK_CHECK),
          HELIUM_DETECTOR_USE = VALUES(HELIUM_DETECTOR_USE),
          ECID_MATCHING = VALUES(ECID_MATCHING),
          COOLING_STAGE_PIN_CONTROL = VALUES(COOLING_STAGE_PIN_CONTROL),
          PUMP_VENT_TIME_ADJUST = VALUES(PUMP_VENT_TIME_ADJUST),
          EPD_PEAK_OFFSET_ADJUST = VALUES(EPD_PEAK_OFFSET_ADJUST),
          TEMP_AUTOTUNE = VALUES(TEMP_AUTOTUNE),
          DOOR_VALVE_CONTROL = VALUES(DOOR_VALVE_CONTROL),
          APC_AUTOLEARN = VALUES(APC_AUTOLEARN),
          PIN_SPEED_HEIGHT_ADJUST = VALUES(PIN_SPEED_HEIGHT_ADJUST),
          GAS_SUPPLY_PRESSURE_CHECK = VALUES(GAS_SUPPLY_PRESSURE_CHECK),
          MFC_HUNTING_CHECK = VALUES(MFC_HUNTING_CHECK),
          FCIP_CAL = VALUES(FCIP_CAL),
          TTTM_SHEET_COMPLETION = VALUES(TTTM_SHEET_COMPLETION),
          OHT_LAY_OUT_CERTIFICATION = VALUES(OHT_LAY_OUT_CERTIFICATION),
          OHT_CERTIFICATION = VALUES(OHT_CERTIFICATION),
          TOOL_PREP_CERTIFICATION = VALUES(TOOL_PREP_CERTIFICATION),
          EFEM_CERTIFICATION_PREP = VALUES(EFEM_CERTIFICATION_PREP),
          TM_CERTIFICATION_PREP = VALUES(TM_CERTIFICATION_PREP),
          PM_CERTIFICATION_PREP = VALUES(PM_CERTIFICATION_PREP),
          SUB_UNIT_CERTIFICATION_PREP = VALUES(SUB_UNIT_CERTIFICATION_PREP),
          RACK_CERTIFICATION_PREP = VALUES(RACK_CERTIFICATION_PREP),
          CERTIFICATION_RESPONSE = VALUES(CERTIFICATION_RESPONSE),
          ENVIRONMENTAL_QUAL_RESPONSE = VALUES(ENVIRONMENTAL_QUAL_RESPONSE),
          AGING_TEST_PROCESS_CONFIRM = VALUES(AGING_TEST_PROCESS_CONFIRM),
          EES_REPORT_PROCEDURE = VALUES(EES_REPORT_PROCEDURE);
  `;

  const values = [
      data.name,
      data.DRAWING_TEMPLATE_SETUP,
      data.DRAWING_TEMPLATE_MARKING,
      data.CUSTOMER_OHT_LINE_CHECK,
      data.UTILITY_SPEC_UNDERSTANDING,
      data.EQUIPMENT_IMPORT_CAUTION,
      data.EQUIPMENT_IMPORT_ORDER,
      data.EQUIPMENT_SPACING_CHECK,
      data.PACKING_LIST_CHECK,
      data.TOOL_SIZE_UNDERSTANDING,
      data.LASER_JIG_ALIGNMENT,
      data.LIFT_CASTER_REMOVAL,
      data.MODULE_HEIGHT_DOCKING,
      data.MODULE_DOCKING,
      data.DOCKING_REALIGNMENT,
      data.LEVELER_POSITION_UNDERSTANDING,
      data.MODULE_LEVELING,
      data.HOOK_UP,
      data.TRAY_CHECK,
      data.CABLE_SORTING,
      data.GRATING_OPEN_CAUTION,
      data.LADDER_SAFETY_RULES,
      data.CABLE_INSTALLATION,
      data.CABLE_CONNECTION,
      data.CABLE_TRAY_ARRANGEMENT,
      data.CABLE_CUTTING,
      data.PUMP_CABLE_TRAY,
      data.PUMP_CABLE_ARRANGEMENT,
      data.CABLE_PM_PUMP_CONNECTION,
      data.GPS_UPS_SPS_UNDERSTANDING,
      data.POWER_TURN_ON_SEQUENCE,
      data.RACK_CB_UNDERSTANDING,
      data.SYCON_NUMBER_UNDERSTANDING,
      data.MODULE_CB_TURN_ON,
      data.SAFETY_MODULE_UNDERSTANDING,
      data.EMO_CHECK,
      data.POWER_TURN_ON_ALARM_TROUBLESHOOTING,
      data.UTILITY_TURN_ON_SEQUENCE,
      data.VACUUM_TURN_ON,
      data.CDA_TURN_ON,
      data.PCW_TURN_ON,
      data.GAS_TURN_ON,
      data.GAS_TURN_ON_CHECK,
      data.OX_NX_GAS_TURN_ON,
      data.MANOMETER_LIMIT_ADJUST,
      data.EFEM_ROBOT_PENDANT_CONTROL,
      data.EFEM_ROBOT_LEVELING,
      data.EFEM_ROBOT_ARM_LEVELING,
      data.EFEM_TEACHING_DATA_SAVE,
      data.TM_ROBOT_PENDANT_CONTROL,
      data.TM_ROBOT_PICK_ADJUST,
      data.TM_ROBOT_BM_TEACHING,
      data.TM_ROBOT_PM_TEACHING,
      data.TM_TEACHING_DATA_SAVE,
      data.WAFER_JIG_USE,
      data.LASER_JIG_USE,
      data.FINE_TEACHING,
      data.MARGIN_CHECK,
      data.SEMI_AUTO_TRANSFER,
      data.AGING_TEST,
      data.BARATRON_PIRANI_GAUGE_INSTALLATION,
      data.EPD_INSTALLATION,
      data.PIO_SENSOR_CABLE_INSTALLATION,
      data.RACK_SIGNAL_TOWER_INSTALLATION,
      data.CTC_INSTALLATION,
      data.PORTABLE_RACK_INSTALLATION,
      data.PM_SAFETY_COVER_INSTALLATION,
      data.PROCESS_KIT_INSTALLATION,
      data.PUMP_TURN_ON,
      data.PM_LEAK_CHECK,
      data.GAS_LINE_LEAK_CHECK,
      data.HELIUM_DETECTOR_USE,
      data.ECID_MATCHING,
      data.COOLING_STAGE_PIN_CONTROL,
      data.PUMP_VENT_TIME_ADJUST,
      data.EPD_PEAK_OFFSET_ADJUST,
      data.TEMP_AUTOTUNE,
      data.DOOR_VALVE_CONTROL,
      data.APC_AUTOLEARN,
      data.PIN_SPEED_HEIGHT_ADJUST,
      data.GAS_SUPPLY_PRESSURE_CHECK,
      data.MFC_HUNTING_CHECK,
      data.FCIP_CAL,
      data.TTTM_SHEET_COMPLETION,
      data.OHT_LAY_OUT_CERTIFICATION,
      data.OHT_CERTIFICATION,
      data.TOOL_PREP_CERTIFICATION,
      data.EFEM_CERTIFICATION_PREP,
      data.TM_CERTIFICATION_PREP,
      data.PM_CERTIFICATION_PREP,
      data.SUB_UNIT_CERTIFICATION_PREP,
      data.RACK_CERTIFICATION_PREP,
      data.CERTIFICATION_RESPONSE,
      data.ENVIRONMENTAL_QUAL_RESPONSE,
      data.AGING_TEST_PROCESS_CONFIRM,
      data.EES_REPORT_PROCEDURE,
  ];
