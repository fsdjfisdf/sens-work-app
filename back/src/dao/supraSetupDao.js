...
exports.insertChecklist = async (checklistData) => {
  ...
  try {
    ...
    `;
    const values = [
      checklistData.name, checklistData.DRAWING_TEMPLATE_SETUP, checklistData.DRAWING_TEMPLATE_MARKING, checklistData.CUSTOMER_OHT_LINE_CHECK, 
      ...
      checklistData.AGING_TEST_PROCESS_CONFIRM, checklistData.EES_REPORT_PROCEDURE
    ];
