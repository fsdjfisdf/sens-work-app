...
exports.addEquipment = async ({ EQNAME, GROUP, SITE, LINE, TYPE }) => {
    ...
    try {
        ...
        INSERT INTO SETUP_EQUIPMENT (
            ...
            INSTALLATION_PREPARATION_COMPANY, FAB_IN_COMPANY, DOCKING_COMPANY, CABLE_HOOK_UP_COMPANY, POWER_TURN_ON_COMPANY, UTILITY_TURN_ON_COMPANY, GAS_TURN_ON_COMPANY, TEACHING_COMPANY, PART_INSTALLATION_COMPANY, LEAK_CHECK_COMPANY, TTTM_COMPANY, CUSTOMER_CERTIFICATION_COMPANY,
            INSTALLATION_PREPARATION_PERCENT, FAB_IN_PERCENT, DOCKING_PERCENT, CABLE_HOOK_UP_PERCENT, POWER_TURN_ON_PERCENT, UTILITY_TURN_ON_PERCENT, GAS_TURN_ON_PERCENT, TEACHING_PERCENT, PART_INSTALLATION_PERCENT, LEAK_CHECK_PERCENT, TTTM_PERCENT, CUSTOMER_CERTIFICATION_PERCENT,
            INSTALLATION_PREPARATION_DATE, FAB_IN_DATE, DOCKING_DATE, CABLE_HOOK_UP_DATE, POWER_TURN_ON_DATE, UTILITY_TURN_ON_DATE, GAS_TURN_ON_DATE, TEACHING_DATE, PART_INSTALLATION_DATE, LEAK_CHECK_DATE, TTTM_DATE, CUSTOMER_CERTIFICATION_DATE,
