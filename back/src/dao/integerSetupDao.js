...
exports.insertChecklist = async (checklistData) => {
    ...
    try {
      ...
      INSERT INTO INTEGER_SETUP (
        ...
        POWER_TURN_ON_ALARM_TROUBLESHOOTING, CHECKLIST_COMPLETION, IP_ADDRESS_CHANGE, UTILITY_TURN_ON_PRECHECK, 
        SETUP_INI_MODIFICATION, UTILITY_TURN_ON_SEQUENCE, VACUUM_TURN_ON, CDA_TURN_ON, PCW_TURN_ON, SOLANOID_VALVE_LOCATION, 
        RELIEF_VALVE_LOCATION, MANUAL_VALVE_LOCATION, PUMP_TURN_ON, PURGE_N2_TURN_ON, DILLUTION_SIGNAL_CHECK, 
        CHILLER_HEAT_EXCHANGER_TURN_ON, CHILLER_HEAT_EXCHANGER_CHECK, MANOMETER_LIMIT_ADJUST, GAS_TURN_ON_PRECHECK, 
        NF3_LINE_LEAK_CHECK, H2_LINE_LEAK_CHECK, NF3_TURN_ON, H2_TURN_ON, GAS_TURN_ON_CHECK, GAS_TURN_ON_CAUTION, 
        PM_DILLUTION_TEST, GAS_TURN_ON_CONFIRM, EFEM_ROBOT_PENDANT_CONTROL, EFEM_ROBOT_XYZ_VALUES, 
        ...
        APC_AUTOLEARN, PIN_HEIGHT_ADJUST_B, GAS_SUPPLY_PRESSURE_CHECK, GAS_EXHAUST_MONAMETER_CONTROL, 
      ...
      const values = [
        ...
        checklistData.CHECKLIST_COMPLETION, checklistData.IP_ADDRESS_CHANGE, checklistData.UTILITY_TURN_ON_PRECHECK, 
        checklistData.SETUP_INI_MODIFICATION, checklistData.UTILITY_TURN_ON_SEQUENCE,
        ...
        checklistData.GAS_TURN_ON_CHECK, checklistData.GAS_TURN_ON_CAUTION, checklistData.PM_DILLUTION_TEST, 
        checklistData.GAS_TURN_ON_CONFIRM, checklistData.EFEM_ROBOT_PENDANT_CONTROL, 
        ...
        checklistData.APC_AUTOLEARN, checklistData.PIN_HEIGHT_ADJUST_B, checklistData.GAS_SUPPLY_PRESSURE_CHECK, checklistData.GAS_EXHAUST_MONAMETER_CONTROL, 
...
const query = `
  UPDATE INTEGER_SETUP SET
    ...
    UTILITY_TURN_ON_PRECHECK = ?, SETUP_INI_MODIFICATION = ?, UTILITY_TURN_ON_SEQUENCE = ?, VACUUM_TURN_ON = ?,
    CDA_TURN_ON = ?, PCW_TURN_ON = ?, SOLANOID_VALVE_LOCATION = ?, RELIEF_VALVE_LOCATION = ?, MANUAL_VALVE_LOCATION = ?,
    PUMP_TURN_ON = ?, PURGE_N2_TURN_ON = ?, DILLUTION_SIGNAL_CHECK = ?, CHILLER_HEAT_EXCHANGER_TURN_ON = ?,
    CHILLER_HEAT_EXCHANGER_CHECK = ?, MANOMETER_LIMIT_ADJUST = ?, GAS_TURN_ON_PRECHECK = ?, NF3_LINE_LEAK_CHECK = ?,
    H2_LINE_LEAK_CHECK = ?, NF3_TURN_ON = ?, H2_TURN_ON = ?, GAS_TURN_ON_CHECK = ?, GAS_TURN_ON_CAUTION = ?,
    PM_DILLUTION_TEST = ?, GAS_TURN_ON_CONFIRM = ?, EFEM_ROBOT_PENDANT_CONTROL = ?, EFEM_ROBOT_XYZ_VALUES = ?,
    EFEM_ROBOT_PARAMETER_EDIT = ?, EFEM_TEACHING_DATA_SAVE = ?, TM_ROBOT_PENDANT_CONTROL = ?, TM_ROBOT_LEVELING = ?,
    TM_ROBOT_XYZ_VALUES = ?, TM_ROBOT_PM_TEACHING = ?, TM_ROBOT_AM_TEACHING = ?, TM_TEACHING_DATA_SAVE = ?,
    ...
    LOAD_LOCK_LEVELING = ?, TM_ROBOT_PICK_INSTALLATION = ?, TM_ROBOT_PICK_LEVELING = ?, GAS_BOX_WINDOW_INSTALLATION = ?,
    ...
    DOOR_VALVE_CONTROL = ?, APC_AUTOLEARN = ?, PIN_HEIGHT_ADJUST_B = ?, GAS_SUPPLY_PRESSURE_CHECK = ?,
  ...
  `;
      ...
      const values = [
        ...
        checklistData.SYCON_TROUBLESHOOTING, checklistData.POWER_TURN_ON_ALARM_TROUBLESHOOTING, checklistData.CHECKLIST_COMPLETION, 
        checklistData.IP_ADDRESS_CHANGE, checklistData.UTILITY_TURN_ON_PRECHECK, checklistData.SETUP_INI_MODIFICATION, 
        checklistData.UTILITY_TURN_ON_SEQUENCE, checklistData.VACUUM_TURN_ON, checklistData.CDA_TURN_ON, checklistData.PCW_TURN_ON, 
        checklistData.SOLANOID_VALVE_LOCATION, checklistData.RELIEF_VALVE_LOCATION, checklistData.MANUAL_VALVE_LOCATION, 
        checklistData.PUMP_TURN_ON, checklistData.PURGE_N2_TURN_ON, checklistData.DILLUTION_SIGNAL_CHECK, checklistData.CHILLER_HEAT_EXCHANGER_TURN_ON, 
        checklistData.CHILLER_HEAT_EXCHANGER_CHECK, checklistData.MANOMETER_LIMIT_ADJUST, checklistData.GAS_TURN_ON_PRECHECK, 
        checklistData.NF3_LINE_LEAK_CHECK, checklistData.H2_LINE_LEAK_CHECK, checklistData.NF3_TURN_ON, checklistData.H2_TURN_ON, 
        checklistData.GAS_TURN_ON_CHECK, checklistData.GAS_TURN_ON_CAUTION, checklistData.PM_DILLUTION_TEST, checklistData.GAS_TURN_ON_CONFIRM,
        checklistData.EFEM_ROBOT_PENDANT_CONTROL, 
        checklistData.EFEM_ROBOT_XYZ_VALUES, checklistData.EFEM_ROBOT_PARAMETER_EDIT, checklistData.EFEM_TEACHING_DATA_SAVE, 
        checklistData.TM_ROBOT_PENDANT_CONTROL, checklistData.TM_ROBOT_LEVELING, checklistData.TM_ROBOT_XYZ_VALUES, checklistData.TM_ROBOT_PM_TEACHING, 
        checklistData.TM_ROBOT_AM_TEACHING, checklistData.TM_TEACHING_DATA_SAVE, checklistData.WAFER_JIG_USE, checklistData.LASER_JIG_USE, 
        checklistData.MARGIN_CHECK, checklistData.SEMI_AUTO_TRANSFER, checklistData.AGING_TEST, checklistData.CERAMIC_PLATE_PIN_INSTALLATION, 
        ...
        checklistData.LP_CERTIFICATION, checklistData.FULL_PUMPING, checklistData.MID_OPERATION_CERTIFICATION_PREP, checklistData.LABEL_PLACEMENT, 
        checklistData.I_MARKING_PROCEDURE, checklistData.I_MARKING_LOCATION, checklistData.GAS_BOX_BOARD_LEVELING, checklistData.ENVIRONMENTAL_QUAL_TEST, 
        checklistData.OHT_AUTO_TRANSFER_CERTIFICATION, checklistData.PARTICLE_TEST, checklistData.EA_TEST, checklistData.name
      ];
