...
exports.insertChecklist = async (checklistData) => {
    ...
    try {
      const query = `
        INSERT INTO INTEGER_MAINT_SELF (
          name, SWAP_KIT, GAS_LINE_&_GAS_FILTER, 
          TOP_FEED_THROUGH, GAS_FEED_THROUGH,
          ...
          VACUUM_BLOCK, CHECK_VALVE, EPC,
          PURGE_LINE_REGULATOR,
    ...
    const values = [
      checklistData.name, checklistData['SWAP_KIT'], checklistData['GAS_LINE_&_GAS_FILTER'],
      checklistData['TOP_FEED_THROUGH'], checklistData['GAS_FEED_THROUGH'], // new 2
      ...
      checklistData['BELLOWS'], checklistData['EFEM_ROBOT_REP'], checklistData['TM_ROBOT_REP'], checklistData['EFEM_ROBOT_TEACHING'], checklistData['TM_ROBOT_TEACHING'],
      checklistData['TM_ROBOT_SERVO_PACK'], //new 1
      checklistData['UNDER_COVER'], checklistData['VAC._LINE'], checklistData['BARATRON_GAUGE'],
      ...
      checklistData['PURGE_LINE_REGULATOR'], // new 1
      checklistData['COOLING_CHUCK'], checklistData['HEATER_CHUCK'], checklistData['GENERATOR'],
      checklistData['D-NET_BOARD'], checklistData['SOURCE_BOX_BOARD'], checklistData['INTERFACE_BOARD'], checklistData['SENSOR_BOARD'], checklistData['PIO_SENSOR_BOARD'], // new 5
      checklistData['AIO_CALIBRATION[PSK_BOARD]'], checklistData['AIO_CALIBRATION[TOS_BOARD]'], checklistData['CODED_SENSOR'], checklistData['GAS_BOX_DOOR_SENSOR'],
      checklistData['LASER_SENSOR_AMP'], checklistData['HE_LEAK_CHECK'], checklistData['DIFFUSER'], checklistData['LOT_조사'],
      checklistData['GAS_SPRING'] //new 1
    ];
    ...
    try {
      const query = `
        UPDATE INTEGER_MAINT_SELF SET
          ...
          ISOLATION_VALVE = ?, VACUUM_BLOCK = ?, CHECK_VALVE = ?, EPC = ?,
      ...
      const values = [
        checklistData['SWAP_KIT'], checklistData['GAS_LINE_&_GAS_FILTER'],
        
        checklistData['TOP_FEED_THROUGH'], checklistData['GAS_FEED_THROUGH'],
        
        checklistData['CERAMIC_PARTS'], checklistData['MATCHER'],
        ...
        checklistData['TM_ROBOT_REP'], checklistData['EFEM_ROBOT_TEACHING'], checklistData['TM_ROBOT_TEACHING'],
        
        checklistData['TM_ROBOT_SERVO_PACK'],
        
        checklistData['UNDER_COVER'],
        ...
        checklistData['CHECK_VALVE'], checklistData['EPC'], 
        
        checklistData['PURGE_LINE_REGULATOR'],
